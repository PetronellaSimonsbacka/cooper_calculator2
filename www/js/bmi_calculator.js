...
function setWomanMessage (obj, value){
  if (value == 1) {
    obj.bmiMessage = "superwoman"
  }
  if (value == 2) {
    obj.bmiMessage = "above average"
  }
  if (value == 3) {
    obj.bmiMessage = "average"
  }
  if (value == 4) {
    obj.bmiMessage = "below average"
  }
  if (value == 5) {
    obj.bmiMessage = "in need to get in shape."
  }
}
...
function setManMessage (obj, value){
  ...
  if (value == 5) {
    obj.bmiMessage = "in serious need to get in shape."
  }
}
